...
const pt: Dict = {
  ...
  "hero.stat3v": "Zero",
  "hero.imageAlt":
    "iPhone a mostrar o painel do GuiaFin com saldo, gráfico de despesas e categorias",
  ...
  "t1.q":
    "Finalmente uma app que não me pede a conta do banco. Em duas semanas percebi onde gastava a mais.",
  "t1.n": "Marta Rocha",
  ...
  "cta.subtitle":
    "Instale o GuiaFin e tenha uma visão clara das suas finanças em menos de cinco minutos.",
...
const en: Dict = {
  ...
  "hero.stat3v": "Zero",
  "hero.imageAlt":
    "iPhone showing the GuiaFin dashboard with balance, expense chart and categories",
  ...
  "t1.q":
    "Finally an app that doesn't ask for my bank login. In two weeks I saw exactly where I overspent.",
  "t1.n": "Marta Rocha",
  "t1.r": "Designer, Lisbon",
  "t2.q":
    "Instalment tracking changed everything. I know exactly what I owe until the end of the year.",
  "t2.n": "Diogo Antunes",
  "t2.r": "Engineer, Porto",
...
const es: Dict = {
  ...
  "t1.q":
    "Por fin una app que no me pide las claves del banco. En dos semanas vi dónde gastaba de más.",
  "t1.n": "Marta Rocha",
  ...
  "cta.subtitle":
    "Instala GuiaFin y ten una visión clara de tus finanzas en menos de cinco minutos.",
  "cta.appstore": "App Store",
