...
const pt: Dict = {
  ...
  "s.dash.t": "Ecrã inicial",
  "s.dash.d": "Saldo total, contas e a pontuação de saúde financeira do mês.",
  "s.movements.t": "Movimentos",
  "s.movements.d": "Todos os lançamentos do mês, por dia, com receitas e despesas separadas.",
  ...
  "s.install.t": "Prestações",
  "s.install.d": "Cada plano com o seu progresso: quantas pagaste e quanto falta.",
  "s.menu.t": "Menu lateral",
  "s.menu.d": "Contas, total disponível, cartões e atalhos num só sítio.",
  ...
  "s.annual.t": "Análises do ano",
  "s.annual.d": "Entradas e saídas mês a mês, e para onde foi o dinheiro.",
...
const en: Dict = {
  ...
  "s.dash.t": "Home screen",
  "s.dash.d": "Total balance, accounts and the month's financial health score.",
  "s.movements.t": "Transactions",
  "s.movements.d": "Every entry of the month, by day, with income and expenses apart.",
  ...
  "s.install.t": "Instalments",
  "s.install.d": "Each plan with its progress: how many are paid and what is left.",
  "s.menu.t": "Side menu",
  "s.menu.d": "Accounts, available total, cards and shortcuts in one place.",
  ...
  "s.annual.t": "Yearly analysis",
  "s.annual.d": "Money in and out month by month, and where it went.",
...
const es: Dict = {
  ...
  "s.dash.t": "Pantalla de inicio",
  "s.dash.d": "Saldo total, cuentas y la puntuación de salud financiera del mes.",
  "s.movements.t": "Movimientos",
  "s.movements.d": "Todos los apuntes del mes, por día, con ingresos y gastos separados.",
  "s.banks.t": "Saldos por banco",
  ...
  "s.install.t": "Plazos",
  "s.install.d": "Cada plan con su progreso: cuántas pagaste y cuánto falta.",
  "s.menu.t": "Menú lateral",
  "s.menu.d": "Cuentas, total disponible, tarjetas y accesos en un solo sitio.",
  ...
  "s.annual.t": "Análisis del año",
  "s.annual.d": "Entradas y salidas mes a mes, y adónde fue el dinero.",
