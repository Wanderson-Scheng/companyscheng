...
const pt: Dict = {
  ...
  "pricing.title": "Escolha o seu plano após o trial",
  "pricing.subtitle": "Descarregue grátis e experimente 30 dias. Depois, ative uma licença.",
  ...
  "download.title": "Descarregue gratuitamente",
  "download.subtitle":
    "Experimente todas as funcionalidades durante 30 dias, sem cartão de crédito. Escolha um plano quando estiver pronto.",
  "download.availableOn": "Disponível na",
  "download.directDownload": "Download direto",
  "download.trialInfo": "Inclui 30 dias de teste gratuito com todas as funcionalidades.",
...
const en: Dict = {
  ...
  "pricing.title": "Choose your plan after the trial",
  "pricing.subtitle": "Download free and try for 30 days. Then activate a licence.",
  ...
  "download.subtitle":
    "Try all features for 30 days, no credit card required. Choose a plan when you're ready.",
  "download.availableOn": "Available on",
  "download.directDownload": "Direct download",
  "download.trialInfo": "Includes 30-day free trial with all features.",
...
const es: Dict = {
  ...
  "pricing.title": "Elija su plan tras el periodo de prueba",
  "pricing.subtitle": "Descargue gratis y pruebe 30 días. Después, active una licencia.",
  ...
  "download.title": "Descargue gratuitamente",
  "download.subtitle":
    "Pruebe todas las funciones durante 30 días, sin tarjeta de crédito. Elija un plan cuando esté listo.",
  "download.availableOn": "Disponible en",
  "download.directDownload": "Descarga directa",
  "download.trialInfo": "Incluye 30 días de prueba gratuita con todas las funciones.",
