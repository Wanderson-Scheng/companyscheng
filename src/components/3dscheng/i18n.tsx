...
const pt: Dict = {
  ...
  "pricing.trialNote": "Todos os planos incluem 30 dias de teste gratuito.",
...
const en: Dict = {
  ...
  "pricing.trialNote": "All plans include a 30-day free trial.",
...
const es: Dict = {
  ...
  "pricing.trialNote": "Todos los planes incluyen 30 días de prueba gratuita.",
